...
public class SparqlService {
    ...
    private ClassesRequestsService findOntologyClassService = new ClassesRequestsService();

    private PredicatesRequestsService triplesService = new PredicatesRequestsService();

    private AlternativeAnswersHandler alternativeAnswersHandler = new AlternativeAnswersHandler();
